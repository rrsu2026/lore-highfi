...
const NavBar = ({ currentScreen }) => {
  ...
  const isSearchHighlighted = ["SearchPage", "SearchResults"].includes(
    currentScreen
  );
  ...
  const icons = [
    {
      ...
      label: "Search",
      isHighlighted: currentScreen === "SearchPage",
    },
    {
      screen: "HomePage",
      icon: "home",
      ...
      label: "Home",
      isHighlighted: currentScreen === "HomePage",
    },
    {
      screen: "MyProfile",
      icon: "person",
      ...
      label: "My Profile",
      isHighlighted: currentScreen === "MyProfile",
    },
  ];
        ...
        >
          <View
            style={[
              ...
              isHighlighted && {
                backgroundColor: Colors.colors.complementColor3,
              },
            ]}
          />
          <Ionicons
            ...
            color={
              isHighlighted
                ? Colors.colors.chineseBlack
                : Colors.colors.graniteGray
            }
          />
          <Text
            style={[
